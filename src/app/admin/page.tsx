  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="/admin/productos" className="block p-4 border rounded-lg hover:shadow-sm transition-shadow">
          <div className="font-semibold">Productos</div>
          <div className="text-sm text-gray-500">Listar y administrar productos</div>
        </a>
        <a href="/admin/productos/nuevo" className="block p-4 border rounded-lg hover:shadow-sm transition-shadow">
