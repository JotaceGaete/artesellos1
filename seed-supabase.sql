...
-- Insertar producto Shiny 842
INSERT INTO products (name, slug, description, short_description, price, regular_price, sale_price, on_sale, images, categories, attributes, stock_status, stock_quantity, weight, dimensions, tags, featured, stamp_info, customization_options) VALUES
(
  'Shiny 842 - Automático - Medidas 38x14',
  'shiny-842-automatico-medidas-38x14',
  'Timbre automático Shiny 842 con medidas estándar de 38mm de ancho por 14mm de alto. Perfecto para uso profesional y personal. Incluye almohadilla de tinta reemplazable.',
  'Timbre automático profesional con medidas 38x14mm',
  32.00,
  32.00,
  NULL,
  FALSE,
  '[{"id": "7", "src": "https://picsum.photos/400/400?random=7", "name": "Shiny 842 Automático", "alt": "Timbre automático Shiny 842 medidas 38x14"}]',
  '["profesionales"]',
  '[{"id": "7", "name": "Tipo de tinta", "options": ["Negra", "Azul", "Roja"], "visible": true, "variation": false}]',
  'instock',
  25,
  0.08,
  '{"length": "12", "width": "12", "height": "3"}',
  '["profesional", "automatico"]',
  TRUE,
  '{
    "type": "automatic",
  ...
  '{
    ...
    "dimension_limits": {"min_width": 30, "max_width": 50, "min_height": 10, "max_height": 20, "unit": "mm"},
    "text_customization": {"max_lines": 2, "max_chars_per_line": 18, "supported_fonts": ["Arial", "Times New Roman", "Courier"], "allow_multiline": true},
    "color_options": {"available_colors": ["#000000", "#000080", "#800000", "#008000"], "default_color": "#000000"},
    "price_multipliers": {"dimension_multiplier": 0.025, "color_multiplier": 2.50, "text_multiplier": 4.00}
  }'
);
